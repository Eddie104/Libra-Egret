module libra.collection {
    ...
    export class List {
         ...
         * @returns {boolean}
         */
        public addItems(items: List): boolean {
         ...
         * @returns {boolean}
         */
        public containsAll(items: List): boolean {
            return libra.utils.arrayUtil.containsAll(this._collection, items.toArray());
        }
         ...
         * @returns {lcp.List}
         */
        public subList(startIndex: number = 0, endIndex: number = 16777215): List {
        ...
        public removeAllInstancesOfItem(item: any): boolean {
            return libra.utils.arrayUtil.removeItem(this._collection, item) != 0;
        }
         ...
         * @returns {boolean}
         */
        public removeItems(items: List): boolean {
            return libra.utils.arrayUtil.removeItems(this._collection, items.toArray());
        }
         ...
         * @returns {boolean}
         */
        public retainItems(items: List): boolean {
            return libra.utils.arrayUtil.retainItems(this._collection, items.toArray());
        }
